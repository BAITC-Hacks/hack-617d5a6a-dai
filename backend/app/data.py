...
ROLE_INFO = [
    ("consolidator", "Консолидатор", "Получает переводы от нескольких разных клиентов"),
    ("transit", "Транзит", "Есть входящие и исходящие переводы; правило видит сопоставимые суммы или быстрые пары"),
    ("distributor", "Распределитель", "Отправляет переводы многим разным получателям"),
    ("terminal", "Получатель без видимых исходящих", "Деньги пришли; исходящих переводов в выгрузке не видно"),
    ("coordinator", "Координатор", "Соединяет ветви наблюдаемого графа; управление счетами не установлено"),
    ("peripheral", "Периферия", "Роль по доступным переводам не выделена"),
]
