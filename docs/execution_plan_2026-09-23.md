...
Время по Asia/Almaty, в скобках T+N минут от старта разработки. Старт ≈13:00 (первые коммиты команды 13:34–13:52), сдача ≈18:00 (T+300); точное время старта и дедлайна команда не подтвердила, поэтому контрольные точки ниже привязаны к 18:00. Пути от корня репозитория `hack-617d5a6a-dai`.
...
| Амир | сценарий, приёмка, формулировки скора и порога, README вне технических разделов, питч; код не пишет | `README.md` (кроме разделов Ивана), `docs/acceptance.md` |
