# Координатор казны — «Граф денег»: роли и приоритеты проверки в сети переводов

Кейс HackAlem AI «Граф денег», команда DAI. «Координатор казны» — имя инструмента: он показывает, кто в наблюдаемой сети переводов координирует движение денег, кто собирает, кто раздаёт и кто пропускает дальше, и ставит клиентов в очередь проверки с объяснением по числам. Все выводы — гипотезы для проверки аналитиком.
